...
$titulo_pagina = 'Cambio climático | Datos e indicadores';
$meta_descripcion = 'Cambio climático: temperatura global, emisiones de CO2, concentración atmosférica, gases de efecto invernadero y olas de calor en España.';
...
<main id="contenido">
  <section id="inicio" class="hero">
    <div class="container hero-grid">
      <div class="hero-copy">
        <p class="eyebrow">Clima · emisiones · atmósfera</p>
        <h1>Cambio climático y calentamiento global</h1>
        <p class="hero-lead">
          Un recorrido visual por algunos de los principales indicadores del cambio climático:
          aumento de temperatura, emisiones de CO₂, concentración atmosférica, gases de efecto
          invernadero y olas de calor en España.
        </p>
      ...
      <aside class="hero-card" aria-label="Resumen del recurso">
        ...
        <p class="hero-card-text">
          temperatura, emisiones, concentración de CO₂, gases de efecto invernadero y olas de calor.
        </p>
    ...
    <div class="reading-content">
      ...
      <section id="emisiones" class="section section-alt section-chapter">
        <div class="container">
          ...
          <article class="chart-card">
            <div class="chart-card-header"><div style="width: 100%;display: flex;gap: 9%;"><span class="source-badge">EPData</span><h3>Evolución de las emisiones de CO₂ en el mundo</h3></div></div>
            <div class="iframe-shell">
