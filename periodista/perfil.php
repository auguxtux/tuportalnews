...
<div id="perfiles-pestana-datos" class="perfiles-pestana-contenido active">
    <div class="perfiles-formulario">
        ...
        <form method="POST">
            ...
            <div class="perfiles-campo-form">
                <label for="periodista_perfil_datos_colaboracion">🤝 Datos de interés para colaborar *</label>
                <textarea id="periodista_perfil_datos_colaboracion" name="datos_colaboracion" rows="6" maxlength="2000" required><?php echo htmlspecialchars($usuario['datos_colaboracion'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
