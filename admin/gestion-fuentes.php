...
<div class="gfuente-container">
    ...
    <?php if ($mensaje): ?>
        ...
        <div class="gfuente-alerta gfuente-alerta-success"><?php echo htmlspecialchars($mensaje, ENT_QUOTES, 'UTF-8'); ?></div>

    <?php endif; ?>

    <?php if ($error): ?>

        <div class="gfuente-alerta gfuente-alerta-error"><?php echo htmlspecialchars($error, ENT_QUOTES, 'UTF-8'); ?></div>
    ...
    <div class="gfuente-card">
        ...
        <form method="POST" class="gfuente-form">
            ...
            <?php if ($fuente_editar): ?>
                ...
                <input type="hidden" name="id_fuente" value="<?php echo (int) $fuente_editar['id_fuente']; ?>">
